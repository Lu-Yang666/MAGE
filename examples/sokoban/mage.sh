...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.use_length_penalty=True \
    +actor_rollout_ref.actor.length_penalty_coef=1.0 \
    ...
    trainer.project_name='mage' \
    trainer.experiment_name=sokoban_${version}_qwen3_4b \
    ...
    2>&1 | tee -a ./logs/sokoban_${version}_qwen3_4b.log
