...
project_name='mage'
experiment_name=tictactoe_${version}_gigpo_qwen3_4b
...
python3 -m verl.trainer.main_ppo \
    ...
    env.tictactoe.mcts_sim_num=$mcts_sim_num \
    env.tictactoe.play_mode=$play_mode \
    env.tictactoe.second_player_ratio=$second_player_ratio \
