...
class TaskRunner:
    def run(self, config):
        ...
        elif 'tictactoesingle' in config.env.env_name.lower():
            from agent_system.environments.TicTacToe.env_manager_single import make_envs
        elif 'kuhnpoker' in config.env.env_name.lower():
            from agent_system.environments.kuhnpoker.env_manager import make_envs
        else:
